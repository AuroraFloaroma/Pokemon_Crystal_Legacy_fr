...
PsychicFranklinBeatenText:
	...
	line "puissante que la"
	cont "mienne!"
	done

PsychicFranklinAfterBattleText:
	text "Tu as rendu ton"
	line "âme plus forte,"
	cont "pas seulement tes"
	cont "capacités. Et ça,"
	cont "c'est bien."
	done
...
MediumDorisAfterBattleText:
	text "Fichtre! J'ai"
	line "oublié que j'avais"
	cont "prédit ma défaite"
	cont "face à toi."
	done
