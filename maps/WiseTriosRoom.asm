...
SageGakuSeenText:
	...
	line "la venue d'un·e"

	para "dresseur·euse"
	line "pouvant toucher"
	cont "l'âme des #MON,"

	para "un #MON viendra"
	line "mettre ce·tte"
	cont "dresseur·euse à"
	cont "l'épreuve dans la"
	cont "TOUR CARILLON."
...
SageKojiAfterBattleSpeechText:
	...
	para "passer que celleux"
	line "au coeur pur."

	para "Entrez et"
	line "découvrez la TOUR"
	cont "CARILLON."
