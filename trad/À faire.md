...
- Remplacer les points d'inclusivité par des points médians (+ inclusion charmap)
- Vérifier tous les noms restant et voir s'il n'y a pas de changement à faire sur la localisation
